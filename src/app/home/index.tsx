...
import { itemsStorage, ItemStorage } from "@/storage/itemsStorate";
...
export function Home() {
  ...
  const [items, setItems] = useState<any>([]); //<any> não é indicado o uso, apenas para teste
  ...
  async function handleAdd() {
    if (!description.trim()) {
      ...
      return showAlert("Adicionar", "Informe a descrição para adicionar.");
    }
    ...
    showAlert("Adicionado", `Adicionado ${description}`);
